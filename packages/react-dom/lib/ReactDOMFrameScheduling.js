...
if (typeof requestAnimationFrame !== 'function') {
  !false ? process.env.NODE_ENV !== 'production' ? invariant(false, 'React depends on requestAnimationFrame. Make sure that you load a polyfill in older browsers.') : _prodInvariant('150') : void 0;
