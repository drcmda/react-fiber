...
function commitCallbacks(finishedWork, queue, context) {
  ...
  for (var i = 0; i < callbackList.length; i++) {
    ...
    !(typeof _callback === 'function') ? process.env.NODE_ENV !== 'production' ? invariant(false, 'Invalid argument passed as callback. Expected a function. Instead received: %s', _callback) : _prodInvariant('187', _callback) : void 0;
