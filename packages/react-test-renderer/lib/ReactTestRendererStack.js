...
var ReactTestComponent = function () {
  ...
  ReactTestComponent.prototype.getPublicInstance = function getPublicInstance() {
    !(this._nodeMock !== UNSET) ? process.env.NODE_ENV !== 'production' ? invariant(false, 'getPublicInstance should not be called before component is mounted.') : _prodInvariant('196') : void 0;
